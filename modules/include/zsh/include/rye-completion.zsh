_rye() {
    ...
    case "${cmd}" in
        rye)
            ...
            ;;
        rye__add)
            opts="-v -q -h --git --url --path --absolute --tag --rev --branch --features --dev --excluded --optional --pre --pin --sync --no-sync --verbose --quiet --help <REQUIREMENTS>..."
        ...
        rye__config)
            ...
            ;;
        rye__fetch)
            opts="-f -v -q -h --force --verbose --quiet --help [VERSION]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        rye__init)
            ...
            ;;
        rye__install)
            opts="-p -f -v -q -h --git --url --path --absolute --tag --rev --branch --features --include-dep --extra-requirement --python --force --verbose --quiet --help <REQUIREMENT>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        rye__list)
            ...
            ;;
        rye__lock)
            opts="-v -q -h --verbose --quiet --update --update-all --pre --features --all-features --with-sources --reset --pyproject --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        rye__publish)
            ...
            ;;
        rye__remove)
            opts="-v -q -h --dev --optional --sync --no-sync --verbose --quiet --help <REQUIREMENTS>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        rye__show)
            ...
            ;;
        rye__sync)
            opts="-f -v -q -h --force --no-dev --no-lock --verbose --quiet --update --update-all --pre --features --all-features --with-sources --pyproject --reset --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        rye__test)
            opts="-a -p -s -v -q -h --all --package --pyproject --no-capture --verbose --quiet --help [EXTRA_ARGS]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
