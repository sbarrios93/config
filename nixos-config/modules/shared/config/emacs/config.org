...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Sebastian Barrios Slight"
    user-mail-address "sbarrios93@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/sbarrios/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/sbarrios/bin" "/profile/bin" "/Users/sbarrios/.npm-packages/bin" "/Users/sbarrios/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
